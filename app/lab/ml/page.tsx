...
/** ROUND 57.12: THE MAPLIBRE NIGHT MAP, IN A LAB (docs/parity/DESIGN-ROUND57.md §9). The home page's
 * sections, word for word, over the MapLibre ground (components/home/ml/) instead of Google's 3D map,
 * to be judged before anything on the home page changes. It exists only on a machine that sets
 * RLT_LAB=1 (read per request: a production build without it answers 404) and is never indexed. */
...
export default async function MapLibreLabPage() {
  ...
  // The ground is always the MapLibre map here; the words are the real map's (g3d) words.
  const g3d = true;
