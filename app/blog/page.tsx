...
export const metadata: Metadata = {
  ...
  description:
    "Hudson Valley real estate advice from RealtyLT: buying, selling, moving, and homeownership guides written for New York buyers and sellers, updated regularly.",
};
