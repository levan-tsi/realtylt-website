// Renders the lead qualification film's OVERLAY as a transparent lossless PNG sequence.
//
...
//   node scripts/film/qualify/render.mjs [--probe 0,7.5,14,21,29,36,42]
...
const FPS = 30;
const LEN = 53.0; // last word ends at 51.47; the tail is the hold on the close card
const OUT = "scripts/_scratch-video/qualify-frames";
const STAGE = "scripts/film/qualify/stage.html";
...
if (probes) {
  ...
  const dir = "scripts/_scratch-video/qualify-probe";
  const BG = "scripts/_scratch-video/qualify-bg/bg.mp4";
