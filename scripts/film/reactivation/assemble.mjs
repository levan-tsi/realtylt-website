// Assembles the DATABASE REACTIVATION film: b-roll bed, transparent type layer, LT narration.
//
...
//   node scripts/film/reactivation/assemble.mjs
...
run(["-i", BG, "-framerate", "30", "-i", `${FRAMES}/f%05d.png`, "-i", `${V}/mix-reactivation.wav`,
  ...
  "-y", `${PUB}/film-reactivation.mp4`], "film");
console.log(`film:   ${mb(`${PUB}/film-reactivation.mp4`)}`);
...
run(["-i", BG, "-i", `${FRAMES}/f00000.png`,
  ...
  "-frames:v", "1", "-q:v", "3", "-y", `${PUB}/film-reactivation-poster.jpg`], "poster");
console.log(`poster: ${mb(`${PUB}/film-reactivation-poster.jpg`)}`);
