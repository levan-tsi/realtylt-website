...
| public/images/home-day-cover.webp | The real map's load cover B, one flag away (`NEXT_PUBLIC_HOME_COVER=day`): the same land by day, `scripts/make-map-cover.mjs --look=day`, hill-shaded from the elevation data credited under `public/geo/` below. Not a screenshot of any map | RealtyLT | Our own artwork | -- |
