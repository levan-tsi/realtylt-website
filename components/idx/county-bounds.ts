...
/** The whole served region (six Hudson Valley counties + five boroughs) — the widest frame
 * the feed covers, and since round 23 the DEFAULT /search frame: the boroughs joined the
 * default scope (owner's call), so the opening viewport has to hold Hudson Valley AND NYC.
