...
const variants: Record<Variant, string> = {
  primary:
    "rounded-xl uppercase tracking-[0.1em] bg-ink text-paper hover:bg-ink-soft active:translate-y-px",
  outline:
  ...
  light:
    "rounded-xl uppercase tracking-[0.1em] bg-paper text-ink hover:bg-mist active:translate-y-px",
