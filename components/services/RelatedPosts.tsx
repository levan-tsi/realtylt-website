        ...
        <ul className="mt-10 grid gap-6 md:grid-cols-2">
          {posts.map((p, i) => (
            <Reveal key={p.slug} as="li" delay={i * 110} className="min-w-0">
              <article className="group relative grid h-full grid-cols-[auto_1fr] items-center gap-5 rounded-2xl border border-[#dddddd] bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:border-porchlight/40 hover:shadow-[0_18px_44px_-20px_rgb(16_24_32/0.35)] sm:gap-6 sm:p-5">
