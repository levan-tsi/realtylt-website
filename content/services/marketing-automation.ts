...
export const marketingAutomation: Service = {
  ...
  whatItIs: [
    "It is marketing that reacts. A calendar sends the same email to everyone on day three. Instead, the sequence watches what each lead actually does. What they opened. Which listings they viewed. Which street they keep coming back to. It fires the next touch off that.",
    "It runs across the channels that reach people: email, SMS, social posting, listing promotion, and retargeting. All of it runs from one behavior signal rather than from four tools that do not talk to each other. The lead who is heating up gets more contact. The lead who is six months out gets kept warm without being burned out.",
  ],

  howItWorks: [
    {
      title: "Behavior becomes the trigger",
      body: "Saving a listing, opening a text, viewing the same area three times, or going quiet for a month all mean something different. Each one starts a different sequence.",
    },
    {
      ...
      body: "Someone who just saved a listing gets similar ones today. Someone who has not engaged in weeks gets a market note, not a fifth showing request. Relevance is not about keeping people subscribed. It is about not being reported. That is the thing that quietly costs you the rest of the list.",
    },
    {
      title: "You get told when to step in",
      body: "The system nurtures, but it does not pretend to close. When a lead's behavior says they are ready now, it brings them up and tells you to call.",
    },
    {
      ...
      body: "SPF, DKIM and DMARC are published for the domain you send from. The address in your From line is aligned with them. Authentication is on Google's list of requirements for every sender. The alignment and the published DMARC policy are on its list for senders above five thousand messages a day. Mail that fails is filtered rather than bounced. One-click unsubscribe goes in the headers, and opt-outs are honored in days rather than in the ten business days the statute allows. None of this improves your message. It is what stops the message being judged before anybody reads it.",
    },
  ],
  ...
  useCases: [
    {
      ...
      body: "Someone who enquires today and does a deal next spring hears from a lot of people in between, and most of it is generic. Nurture keeps you present for the wait without asking you to remember. Remembering is the part that fails first.",
    },
    {
      title: "New listing, right audience",
      body: "A listing goes live. The people whose saved criteria it matches hear about it first, by text, before it appears on a portal.",
    },
    {
  ...
  limits: [
    "It does not create demand. It keeps you present for people who already raised their hand. No cadence turns someone who is not moving into someone who is.",
    "It does not fix a bad message. Sending the wrong thing at the right moment is still the wrong thing. Behavior triggers only make it arrive faster.",
    "It does not override an opt-out. A person who asks to stop hearing from you stops hearing from you. The cadence backs off on silence as well as on refusal.",
    "It does not get your mail delivered. Authentication removes a reason to reject you. Whether a message reaches an inbox is a judgement made by the mailbox provider, from how the people you sent to reacted last time. There is no setting for it.",
    "It does not tell you whether anybody read anything. An open is recorded when a mail client fetches a tracking image. Some clients do that automatically and others never do. So it is a proxy with known failure modes in both directions, rather than a measurement of attention.",
    "It does not survive being aimed at everybody. Every send to someone who did not want it is evidence handed to a filtering system. The cost of that lands on the next message to the people who did want it.",
    "It does not replace you calling anyone. A sequence keeps a lead warm. It does not build a relationship. The leads worth having can tell the difference.",
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "A drip campaign sends email three on day seven no matter who you are. Behavior-triggered nurture watches what the lead actually does. It changes the message and the cadence to match, which is why it keeps working past the second email.",
    },
    {
      q: "Will automated marketing annoy my leads?",
      a: "It annoys them when it is irrelevant, which is exactly what behavior triggers fix. A lead who goes quiet gets less contact and different content, not more of the same. The opt-out is always honored. Cadence backs off automatically.",
    },
    {
      ...
      a: "Yes. SMS is part of the same sequence. Texts are sent under a different and stricter set of consent rules than email, with opt-outs honored automatically. And the rules that govern messaging someone who has gone quiet have dates in them.",
    },
    {
      ...
      a: "Not under the federal statute, which is the part most people have backwards. CAN-SPAM sets rules for the message rather than for the relationship. It must identify itself as an advertisement. It must carry a valid physical postal address. And it must offer a working opt-out that stays live for at least thirty days, with the request honored within ten business days. Permission still matters enormously, for a different reason. Mailbox providers judge you on how the people you email react. Mail to people who never asked is what generates the reactions that get the rest of your mail filtered.",
    },
    {
      ...
      a: "Possibly because fewer people opened it, and possibly for two reasons that have nothing to do with your writing. An open is only recorded when a mail client fetches a tracking image. So clients that block or reroute remote images bend the count, and the mix of clients on a list changes over time. Separately, if more of your mail is being filtered, fewer people are being offered the chance to open it at all. Your spam complaint rate is a better health signal than your open rate. Google publishes yours to you free through Postmaster Tools.",
    },
  ],
