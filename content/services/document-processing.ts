...
export const documentProcessing: Service = {
  ...
  figure: {
    ...
    footnote:
      "An illustration rather than a real file. No client, no property and no date here belongs to anybody. What it is showing is the third row. A value the system cannot settle is held back for a person, rather than written with the likeliest guess. That is because a wrong date inherits the authority of your calendar, and a blank one does not.",
  },

  whatItIs: [
    "It reads the paperwork. A purchase agreement, a disclosure, or a lease goes in. The terms, the key dates and the parties come out as structured data, rather than as a PDF somebody has to open and squint at.",
    "It also tells you what is wrong. That means the missing signature, the field left blank, and the date that contradicts another date. Then it files everything into your CRM and your transaction folder, and puts the deadlines on the calendar.",
  ],

  howItWorks: [
    {
      title: "Drop the document in",
      body: "Purchase agreements, disclosures, leases and addenda. Scans and photographs are handled as well as clean PDFs. The quality of the original is the single biggest thing that moves how much comes back.",
    },
    {
    ...
    },
    {
      ...
      body: "Missing fields, missing signatures and anything the reader is not confident about all go to a person. What is settled is written to the CRM and the transaction folder. The deadlines go on your calendar.",
    },
    {
  ...
  useCases: [
    {
      ...
      body: "Key dates reach the calendar on the day the document arrives. They do not wait until someone gets round to reading page nine.",
    },
    {
  ...
  limits: [
    "It does not guarantee a date. Misreading a line on a scanned rider is the failure mode of this whole category. That is why anything it is not confident about is flagged for a person rather than filed quietly.",
    "It does not know what a value means. It reads what the page says. Turning a period into a date needs a counting rule, and that rule lives in your business rather than in the document. If nobody has written it down, the software has picked one for you.",
    ...
    "It does not fix a document. A missing signature gets flagged, not solved. Chasing it is a person's work.",
  ],
  ...
  faqs: [
    {
      ...
      a: "Yes, and how well depends far more on the page than on the software. Printed text in a clean PDF is the easy case. A scan or a phone photograph is harder. Published research on real scanned forms found that most of the loss happens in finding the words on the page, rather than in reading them. What it does not do is give a legal opinion, and it should not.",
    },
    {
      q: "What happens if it gets something wrong?",
      a: "Anything it is not confident about is flagged for a human rather than filed silently. That design exists because the two failures are not equally expensive. A blank field gets noticed, and it costs a few minutes. A wrong date that looks right is believed by everybody downstream.",
    },
    {
      q: "Is the extracted data the legal record?",
      a: "No. The fields are a reading of the document made on a particular day. They drop whatever the reader was not looking for, including a strike-through or a note in a margin. The federal rule on retaining electronic records asks for something that accurately reflects the information set forth in the contract. So the original stays the record, and every extracted value should carry the document and page it came from.",
    },
    {
      q: "Can it read handwriting?",
      a: "Often, and the honest answer has a shape to it. Neat handwriting in a box designed for it is usually fine. What is truly hard is what matters most in real estate paperwork. A figure written over a struck-through one. A date altered in a margin. Initials that are not meant to be legible even to a person. Those are the marks a build should be designed to flag rather than guess at.",
    },
    {
      q: "Does it replace a transaction coordinator?",
      a: "It removes the re-keying and the deadline tracking. That is the part of the job that is mechanical, and the part where mistakes happen. The judgment, the chasing, and the client relationship stay with a person.",
    },
  ],
