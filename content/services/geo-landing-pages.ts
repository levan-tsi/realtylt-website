...
export const geoLandingPages: Service = {
  ...
  seo: {
    ...
    description:
      "Local landing pages for your business: a real page for every area you serve, written to rank in Google and be quoted in AI answers. Not thin doorway pages.",
  },
  ...
  figure: {
    ...
    nodes: [
      ...
      { label: "A person reads it", note: "Before it is published, not after someone complains about it." },
      { label: "It captures the lead", note: "On your own site. Not on a directory that rents you back the click." },
    ],
    ...
    footnote: "Google's spam policy names this tactic twice. One of the examples is generative AI making many pages without adding value. The work is in making each one real.",
  },
  ...
  howItWorks: [
    {
      ...
      body: "Written for the area, with the work you have actually done there. Google's own test for first-hand expertise gives visiting a place as its example. There is no writing technique that produces it.",
    },
    {
      title: "Answers written to be quoted",
      body: "The real question as a heading. The answer in the sentence underneath it. Plus the structured data that lets a machine understand the page. The same format is what works for a person in a hurry.",
    },
    {
      title: "Lead capture on your own ground",
      body: "The form is on your site. So the lead is yours. It is not a directory's to sell back to you.",
    },
  ],
  ...
  useCases: [
    {
      ...
      body: "A real page for each one. Not a single page that mentions eight towns in a sentence and belongs to none of them.",
    },
    {
      title: "Being quoted in an AI answer",
      body: "Assistants answer from pages that answer questions directly. So a page written that way can be quoted. Nobody controls what gets quoted. Writing a page worth quoting is the only lever there is.",
    },
    {
      title: "Owning the lead instead of renting it",
      body: "The directory that ranks above you is selling your market back to you. Your page captures it directly.",
    },
  ],

  limits: [
    "It is not a template with the town name swapped. Google's spam policy names doorway abuse and scaled content abuse separately. The second one gives generative AI producing many pages without adding value as its first example.",
    "It does not rank a place you do not serve. A page for an area you have never worked has nothing true to put on it. Both a reader and an engine notice.",
    ...
    "It does not make your list of areas longer than it is. How many places you can write honestly about is a fact about your career so far. The honest version of this project usually produces a shorter list than the first meeting did.",
    ...
    "It does not survive being left alone. The closing was three years ago, the tax figure moved, the shop closed. Most of these pages need a short sitting once a year. A set nobody goes back to becomes a record of when you stopped paying attention.",
  ],

  faqs: [
    {
      q: "What are GEO landing pages?",
      a: "They are pages built for a specific location and service. Someone searching for that service in that place then finds a page that is actually about it. GEO now carries a second meaning as well. That is generative engine optimisation, which means writing pages AI assistants can quote when they answer a question.",
    },
    {
      q: "Are location pages considered doorway pages by Google?",
      a: "Only if they behave like one. Google's spam policy defines doorway abuse as pages created to rank for specific, similar queries that lead users to intermediate pages less useful than the final destination. It gives an example: pages targeted at specific regions or cities that funnel users to one page. Nothing in the policy forbids having a page per area. A page that answers the question it was found for, on its own, is not doing what that entry describes.",
    },
    {
      q: "Is it against the rules to have AI write them?",
      a: "Not in itself. Google's guidance on helpful content frames automation as a question about the output rather than the tool. What the spam policy names is using generative AI tools to generate many pages without adding value for users. The difference is whether anything was added between the draft and the publication. In practice that means a person who knows the place read it and changed it before it went live.",
    },
    {
      ...
      a: "Yes, and it is the part nobody raises. The advertising rules apply to a web page exactly as they apply to a flyer. 24 CFR 100.75 says written statements include any documents used with respect to the sale of a dwelling. It names selecting locations for advertising that deny parts of the housing market information about housing opportunities because of race, colour, religion, sex, handicap, familial status or national origin. 24 CFR 100.70 names discouraging someone, on those same grounds, by exaggerating drawbacks or failing to inform them of the desirable features of a community. Both turn on the reason. So an uneven set of pages is not unlawful by itself. In practice, write about the housing and the transaction rather than about who lives somewhere. And give your areas comparable effort. The pattern across a set of pages is the thing a reason gets read off. And it is invisible from inside any one of them.",
    },
    {
      q: "How do I get my business cited in ChatGPT or Google AI Overviews?",
      a: "Answer the question directly, in plain language, on a real page that an assistant can read. Structured data helps a machine understand the page. A clear question-and-answer format is what gets quoted. Vague marketing copy does not get cited, because there is nothing in it to quote. Nobody can promise the citation itself.",
    },
  ],
