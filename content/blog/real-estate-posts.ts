/** The consumer real estate articles, reposted from the owner's Google Drive drafts (the "Blog"
 * folder, 2025) and re-verified on 2026-09-24. Each body is in the markdown subset
 * lib/blog/markdown.tsx renders. How one post goes through: docs/blog-repost/PIPELINE.md.
 *
 * House rules for these bodies: plain professional voice, no em dashes, no arrow glyphs; every
 * number that can go out of date carries its year and links the public source it came from
 * (a claim with no reputable source is removed, not kept); the FAQ uses the `## Frequently
 * asked questions` + `### question` convention so lib/blog/toc.ts emits FAQPage JSON-LD. */

export const FIRST_TIME_BUYER_CHECKLIST_POST = `When I bought my first house, I used a first-time home buyer program. After all the numbers were settled at closing, I actually received money back. I was, in effect, paid to buy my house.
...
1. Build your financial foundation: credit, debt-to-income, savings.
2. Get pre-approved, and ask every lender about assistance programs.
3. Choose a local buyer's agent and read the written agreement.
4. Separate your needs from your wants.
5. Search, tour and compare.
6. Make a strong offer.
7. Hire a real estate attorney.
8. Inspect the house and let the lender appraise it.
9. Get your mortgage commitment and homeowners insurance.
10. Do the final walk-through and close.
...
Your credit score is the lender's shorthand for how you handle debt, and it is one of the biggest factors in the interest rate you are offered. Minimums are lower and less fixed than many buyers think. Since November 2025, Fannie Mae no longer applies a hard 620 floor to loans run through its automated underwriting system, Desktop Underwriter, and instead weighs the whole file; manually underwritten loans and many individual lenders still use 620 as a floor ([Fannie Mae](https://singlefamily.fanniemae.com/applications-technology/desktop-underwriter-desktop-originator/desktop-underwriter-credit-risk-assessment-updates)). For an FHA loan, HUD allows the minimum 3.5% down payment with a score of 580 or higher, and a score between 500 and 579 with 10% down ([HUD](https://answers.hud.gov/FHA/s/article/Does-FHA-require-a-minimum-credit-score-and-how-is-it-determined)).
...
Your debt-to-income ratio (DTI) is all of your monthly debt payments divided by your gross monthly income ([CFPB](https://www.consumerfinance.gov/ask-cfpb/what-is-a-debt-to-income-ratio-en-1791/)). If your car payment, student loan and card minimums add up to $1,200 and you earn $6,000 a month before tax, your DTI before housing is 20%.
...
- **Down payment.** You do not need 20% down. Fannie Mae's HomeReady loan allows as little as 3% down for eligible borrowers ([Fannie Mae](https://yourhome.fanniemae.com/buy/homeready)), and FHA allows 3.5% ([HUD](https://answers.hud.gov/FHA/s/article/What-is-the-minimum-down-payment-requirement-for-FHA)). Putting down less than 20% on a conventional loan usually means paying private mortgage insurance until you build equity.
- **Closing costs.** Freddie Mac suggests budgeting 2% to 5% of the purchase price ([Freddie Mac](https://myhome.freddiemac.com/blog/homebuying/what-are-closing-costs-and-how-much-will-i-pay)). New York adds its own items, such as the attorney's fee and the mortgage recording tax; our [guide to buyer closing costs in New York](/blog/buyer-closing-costs-new-york) breaks them down.
...
For the down payment side in detail, read [how much you really need for a down payment in the Hudson Valley](/blog/down-payment-hudson-valley-ny).
...
With a pre-approval and your two lists, the search becomes focused. Set up alerts on our [home search](/search) for the towns and price you have chosen, go to open houses, and book private showings for the homes that pass your needs list.
...
In a competitive situation there are other levers besides price. Our guide to [making a winning offer in the Hudson Valley](/blog/winning-offer-competitive-market-ny-hudson-valley) covers them.

## Step 7: Hire a real estate attorney

In New York, and especially downstate, buyers and sellers are each represented by their own attorney as a matter of long practice. No statute requires it, but the process is built around it: downstate, the seller's attorney usually drafts the contract of sale, and the New York State Bar Association advises consulting an attorney before you sign anything, or immediately after signing a binder that is subject to attorney approval ([NYSBA](https://nysba.org/legalease-the-attorneys-role-in-home-purchase-transactions/)).

This matters because an accepted offer is not yet a signed contract. Until both sides sign the contract of sale, the deal can still change. Your attorney reviews and negotiates the contract, orders the title search, arranges title insurance, and represents you at closing. More on this in [why you need a real estate attorney in New York](/blog/why-you-need-real-estate-attorney-ny).
...
- **Radon.** The New York State Department of Health recommends hiring a certified radon tester before you buy, with results from a state-approved laboratory ([NYSDOH](https://www.health.ny.gov/environmental/radon/)).
- **Private well.** If the house has its own well, test the water. The Department of Health recommends testing at least once a year for bacteria and every three to five years for other contaminants, using a lab certified by its Environmental Laboratory Approval Program ([NYSDOH](https://www.health.ny.gov/environmental/water/drinking/regulations/fact_sheets/fs3_water_quality.htm)). A flow test tells you whether the well keeps up with a household.
...
After the appraisal and any final paperwork, the lender issues its commitment and, eventually, a clear to close. At least three business days before closing, you will receive a Closing Disclosure listing your final loan terms and costs; compare it with your Loan Estimate ([CFPB](https://www.consumerfinance.gov/ask-cfpb/what-is-a-closing-disclosure-en-1983/)).
...
- **The final walk-through** usually happens a day or so before closing. Confirm the house is in the condition you agreed to buy, the seller's belongings are gone, and any agreed repairs are done. Our [final walk-through checklist](/blog/final-walk-through-checklist) covers it room by room.
...
Ten steps look like a lot on a page, but each one is manageable, and several happen at the same time. If you would like to talk through your own numbers, which programs you might qualify for, or which towns fit your budget, [ask us directly](/connect). A first conversation costs nothing.
...
- Fannie Mae, [Desktop Underwriter credit risk assessment updates](https://singlefamily.fanniemae.com/applications-technology/desktop-underwriter-desktop-originator/desktop-underwriter-credit-risk-assessment-updates) and [HomeReady](https://yourhome.fanniemae.com/buy/homeready)
- HUD, [FHA minimum credit score](https://answers.hud.gov/FHA/s/article/Does-FHA-require-a-minimum-credit-score-and-how-is-it-determined) and [minimum down payment](https://answers.hud.gov/FHA/s/article/What-is-the-minimum-down-payment-requirement-for-FHA)
- Consumer Financial Protection Bureau, [debt-to-income ratio](https://www.consumerfinance.gov/ask-cfpb/what-is-a-debt-to-income-ratio-en-1791/) and [Closing Disclosure](https://www.consumerfinance.gov/ask-cfpb/what-is-a-closing-disclosure-en-1983/)
...
- NYS Homes and Community Renewal, [Achieving the Dream](https://hcr.ny.gov/achieving-dream-program), [DPAL](https://hcr.ny.gov/down-payment-assistant-loan-dpal) and [DPAL Plus 2026 term sheet](https://hcr.ny.gov/dpal-plus-2026-term-sheet)
- NYC Department of Housing Preservation and Development, [HomeFirst](https://www.nyc.gov/site/hpd/services-and-information/homefirst-down-payment-assistance-program.page)
- Bank of America, [affordable housing programs](https://www.bankofamerica.com/mortgage/affordable-housing-programs/)
