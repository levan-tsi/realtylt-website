/** Real Estate Investing articles, reposted from the owner's Drive drafts (folder "1.Real Estate
 * Investing & Wealth Building") and re-verified on 2026-09-24. Same house rules as
 * real-estate-posts.ts; the pipeline is docs/blog-repost/PIPELINE.md. Nothing here is tax or
 * legal advice, and every post says so where it touches either. */

export const FIRST_RENTAL_POST = `Owning rental property in the Hudson Valley can build long-term wealth, and it is more reachable than many people assume. What it takes is not a fortune but a plan, and the discipline to run the numbers honestly. This guide explains how to buy your first rental property in the Hudson Valley, step by step: financing, strategy, finding the property, analyzing the deal with 2026 figures, due diligence, and becoming a landlord.
...
- **Down payment.** Fannie Mae's eligibility rules allow up to 85% financing on a one-unit investment property purchase (15% down) and up to 75% on a two- to four-unit investment property (25% down) ([Fannie Mae Eligibility Matrix](https://www.fanniemae.com/content/eligibility_information/eligibility-matrix.pdf)). Many lenders ask for more.
- **Reserves.** For an investment property loan run through Desktop Underwriter, Fannie Mae requires six months of reserves, measured in monthly housing payments, after closing ([Fannie Mae Selling Guide B3-4.1-01](https://selling-guide.fanniemae.com/sel/b3-4.1-01/minimum-reserve-requirements)).
...
Buy a two- to four-unit building, live in one unit and rent the others. Because it is your home, you can use owner-occupant financing: FHA allows 3.5% down on a two- to four-unit home you occupy ([HUD](https://answers.hud.gov/FHA/s/article/What-is-the-minimum-down-payment-requirement-for-FHA)), and with three or four units the projected rent must pass HUD's self-sufficiency test. Fannie Mae requires six months of reserves for a two- to four-unit principal residence as well. Our guide to [house hacking in the Hudson Valley](/blog/house-hacking-hudson-valley-ny) covers it in detail.
...
Know the rents before you look. A useful public reference is HUD's Fair Market Rent: for fiscal year 2026, HUD set the two-bedroom Fair Market Rent for the Kiryas Joel-Poughkeepsie-Newburgh metro area (Dutchess and Orange counties) at $1,979 a month ([HUD USER](https://www.huduser.gov/portal/datasets/fmr/fmrs/FY2026_code/2026summary.odn?fmrtype=Final&selection_type=county&fips=3602799999)). Fair Market Rents are set near the 40th percentile of rents for standard units and include utilities, so treat them as a floor-to-middle reference, then check current listings and your agent's lease data for the specific street. You can browse what is for sale on our [home search](/search).
...
- **Rate:** 7.5%, an assumption; investment property loans usually price above the 7.03% 30-year survey average Freddie Mac reported on September 24, 2026 ([Freddie Mac PMMS](https://www.freddiemac.com/pmms)).
...
That negative number is the most important lesson here. Buy an average property at an average price, charge an average rent, and you lose money every month at today's rates. The job is to find a deal: a property bought below market, a building you can improve to earn more rent, or a multi-family where several rents carry one mortgage. Learn the key metrics in [how to calculate ROI and cap rate on an investment property](/blog/calculate-roi-cap-rate-investment-property-ny).

## Step 5: Make a smart offer and do your due diligence

Base your offer on a comparative market analysis and the property's income. Keep an inspection condition and the mortgage contingency. The New York State Bar Association notes that inspections can take place before or after the contract is signed, and that the buyer's obligation can be conditioned on satisfactory reports ([NYSBA](https://nysba.org/legalease-buying-and-selling-real-estate/)). For a rental, also ask for current leases, rent rolls, security deposit records and utility costs, and confirm the legal number of units with the building department. Use our [home inspection checklist](/blog/home-inspection-checklist-hudson-valley-ny).

## Step 6: Closing and becoming a landlord

At closing you sign, the funds move and you get the keys. Then the landlord work begins: marketing, screening, a sound lease, rent collection and repairs, all within New York's tenant protection rules, which include a limit on security deposits of one month's rent ([New York Attorney General](https://ag.ny.gov/publications/residential-tenants-rights-guide)) and a cap of $20, or the actual cost if lower, on background and credit check fees ([Real Property Law 238-a](https://www.nysenate.gov/legislation/laws/RPP/238-A)). Our guide to [finding and screening tenants in New York](/blog/how-to-find-screen-tenants-ny) covers the rules.

Self-manage or hire a manager? Self-managing maximizes cash flow and teaches you the business, at the cost of your time. A manager costs a share of rent but lets you scale. Many first-time owners self-manage the first property and hire help as they grow; our guide to [hiring a property management company](/blog/hiring-property-management-company-hudson-valley) compares the two.
...
If you want help turning this into a plan for your budget and target towns, see our [buying page](/buying) or [talk with us](/connect).
...
- Fannie Mae, [Eligibility Matrix](https://www.fanniemae.com/content/eligibility_information/eligibility-matrix.pdf) and [Selling Guide B3-4.1-01, minimum reserves](https://selling-guide.fanniemae.com/sel/b3-4.1-01/minimum-reserve-requirements)
- HUD, [FHA minimum down payment](https://answers.hud.gov/FHA/s/article/What-is-the-minimum-down-payment-requirement-for-FHA) and [FY2026 Fair Market Rents, Kiryas Joel-Poughkeepsie-Newburgh](https://www.huduser.gov/portal/datasets/fmr/fmrs/FY2026_code/2026summary.odn?fmrtype=Final&selection_type=county&fips=3602799999)
