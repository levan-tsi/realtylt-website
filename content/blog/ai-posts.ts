...
The FBI's Internet Crime Complaint Center publishes an annual report of what was reported to it. The [2024 edition](https://www.ic3.gov/AnnualReport/Reports/2024_IC3Report.pdf) records 859,532 complaints and $16.6 billion in reported losses. Of those, 256,256 reported an actual loss. The average reported loss the report prints, $19,372, is taken across all 859,532 complaints rather than across only the ones that lost money, which is worth knowing before repeating it. Business email compromise, which is the category a diverted payment instruction falls into, accounts for 21,442 complaints and $2,770,151,146.
