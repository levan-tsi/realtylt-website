...
const ZOMBIES: { name: string; pattern: RegExp; why: string }[] = [
  ...
  },
  {
     ...
     * Probed both ways before it landed: four autonomy forms red, which were this entry's share
     * of the eight injected across it and round L together, and all sixty files in SOURCES
     * green. The count in this docstring said seven until a round-45 checker read it against
     * the round log; the injection was four here and four there. */
    pattern:
